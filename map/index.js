...
//     TrackAnimate,
// } from './install';
import InitMap from './modules/initMap';//初始化地图类
import Correct_500 from './modules/correct/correct_500';//500个点的纠偏方法
import Correct_2 from './modules/correct/correct_2';//两点间纠偏方法
import Correct_40 from './modules/correct/correct_40';//40个点的转换方法
import Correct from './modules/correct/correct';//不纠偏直接先写上
import TrackAnimate from './modules/trackAnimate';//小车的动画
import DrawLines from './modules/drawLines';//画线
/**
 * 工厂类 
 *   初始化地图类 --InitMap
 *   绘制历史轨迹类 --Correct_500
